...
require_once("inc/configuration.php"); //inclui a class de conexão

$sql = new Sql();

$result = $sql->query("SELECT * FROM tb_produtos;");

//mysqli_fetch_array trasforma o que veio do banco em array ou seja as row(linhas)
while($row = mysqli_fetch_array($result)){
	// var_dump Mostra a informação que tem lá dentro das variaveis e o tipo de dado
	var_dump($row);
} 

//Para o processamento, não executa mais nada
exit();
